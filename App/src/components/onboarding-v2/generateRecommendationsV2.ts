...
const OBJECTIVE_TEMPLATES: Record<string, HabitTemplate[]> = {
  productivity: [
    {
      ...
      defaultDuration: 8, defaultPeriod: 'morning', defaultFrequencyDays: [1,2,3,4,5], priority: 10,
    },
    {
      ...
      defaultDuration: 8, defaultPeriod: 'late_afternoon', defaultFrequencyDays: [1,2,3,4,5], priority: 9,
    },
    {
  ...
  health: [
    ...
    },
    {
      ...
      description: '12 min ao ar livre sem óculos escuros. Regula cortisol, ajusta relógio circadiano, melhora o sono 16h depois.',
  ...
  mental: [
    {
      code: 'ANCHOR-MENT-01', name: 'Esvaziar a cabeça de manhã',
      description: 'Escrever livremente tudo que está na cabeça. Sem estrutura, sem revisão. Tirar o lixo da mente.',
    ...
    {
      code: 'DIR-MENT-TUE-THU', name: 'Janela de Preocupação',
      description: 'Horário fixo para se preocupar intencionalmente. Anotar o que pesa, pensar no pior cenário, escrever resposta.',
    ...
    {
      code: 'DIR-MENT-WED', name: 'Silêncio Completo',
      description: '15 min sem fazer nada. Sem áudio, leitura, celular. O cérebro processa durante o não-fazer.',
    ...
    {
      code: 'DIR-MENT-SUN', name: 'Carta para a Próxima Semana',
      description: '3-5 linhas para o "eu de segunda-feira". O que lembrar, o que sentir, o que não esquecer.',
  ...
  routine: [
    ...
    {
      code: 'DIR-ROUT-WED', name: 'Limpeza e Ordem',
      description: '15 min para organizar espaço de trabalho. Ambiente desorganizado aumenta cortisol e diminui foco.',
  ...
  avoid: [
    ...
    {
      code: 'ANCHOR-AVOI-02', name: 'Colocar obstáculos no caminho',
      description: 'Celular fora do quarto? App deletado da tela? Cada passo extra reduz probabilidade em ~30%.',
      category: 'avoid', habit_type: 'anchor', icon: '🚧', icon_key: 'block', color: '#F97316',
      defaultDuration: 5, defaultPeriod: 'evening', defaultFrequencyDays: [0,1,2,3,4,5,6], priority: 9,
    },
    {
      code: 'DIR-AVOI-MON', name: 'Contrato Semanal',
      description: 'Declaração escrita: "Esta semana, vou limitar [comportamento] a [janela específica]." 2-3x mais eficaz.',
    ...
    {
      code: 'DIR-AVOI-TUE-THU', name: 'Substituição Planejada',
      description: 'No horário do gatilho, executar comportamento substituto. Comportamentos não morrem por repressão. São substituídos.',
    ...
    {
      code: 'DIR-AVOI-WED', name: 'Auditoria do Padrão',
      description: 'Com 3 dias de dados: em que horário ocorre? Qual emoção antecede? Análise de meio de semana.',
...
const CHALLENGE_TEMPLATES: Record<string, HabitTemplate[]> = {
  ...
  tiredness: [
    ...
    },
    {
      ...
      description: 'Meia-vida de 5-6h. Corte = sleep_time - 8h. Sem isso, metade ainda está no sangue ao dormir.',
  ...
  anxiety: [
    {
      code: 'SUPP-ANXI-01', name: 'Primeiras horas só para você',
      description: 'Nenhuma notícia ou rede social nas primeiras 2h. Proteção do estado mental no período mais vulnerável.',
      category: 'mente', habit_type: 'support', icon: '🛡️', icon_key: 'shield', color: '#EF4444',
      defaultDuration: 120, defaultPeriod: 'dawn', defaultFrequencyDays: [0,1,2,3,4,5,6], priority: 8,
    },
    {
...
const LIFE_AREA_TEMPLATES: Record<string, HabitTemplate[]> = {
  ...
  physical: [
    ...
    } as HabitTemplate & { goal_value: number; goal_unit: string },
    {
      ...
      description: 'Lembretes às 12h, 15h, 18h para 300ml. Desidratação de 2% reduz desempenho cognitivo em 20%.',
