  ...
  <div className="min-h-screen bg-background text-foreground py-16 transition-colors">
    ...
    >
      <div className="mb-8 flex items-center justify-between">
        <Button variant="ghost" className="gap-2 text-muted-foreground hover:text-foreground hover:bg-accent/10" asChild>
          <Link to="/">
      ...
      <Card className="mt-10 rounded-2xl bg-card border border-border divide-y divide-border">
        <section className="space-y-6 p-8">
          <div>
            <h2 className="text-xl font-semibold">1. Identificação da Empresa</h2>
            <div className="mt-3 space-y-1 text-sm text-muted-foreground">
              <p><strong className="text-foreground/90">Razão Social:</strong> BRUNO GIORGIO KAHN FALCI</p>
              <p><strong className="text-foreground/90">CNPJ:</strong> 59.393.438/0001-20</p>
              <p><strong className="text-foreground/90">Endereço:</strong> Rua Tanhaçu, 336 – Jardim Panorama, São Paulo/SP – 05679-040</p>
              <p><strong className="text-foreground/90">E-mail de contato:</strong> <a href={`mailto:${supportEmail}`} className="text-primary underline hover:text-primary/80">{supportEmail}</a></p>
            </div>
          </div>

          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">2. Objeto e descrição do serviço</h2>
            <p className="text-muted-foreground">O Habitz é um aplicativo web que apoia o desenvolvimento de hábitos saudáveis, a prática de meditação e o acompanhamento de rotinas pessoais de bem-estar.</p>
            <p className="font-medium text-foreground/90">Principais funcionalidades:</p>
            ...
            <p className="text-muted-foreground">O Habitz é uma ferramenta de apoio ao desenvolvimento pessoal e não substitui aconselhamento médico, psicológico ou terapêutico. Os resultados dependem exclusivamente da dedicação e consistência de cada usuário.</p>
          </div>

          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">3. Licença de uso e acesso</h2>
            <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">4. Cancelamento e reembolso</h2>
            <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
              ...
              <li>Solicitações devem ser encaminhadas por escrito para <a href={`mailto:${supportEmail}`} className="text-primary underline hover:text-primary/80">{supportEmail}</a>.</li>
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">Todos os conteúdos do Habitz — áudios, textos, design, códigos e algoritmos — são de propriedade exclusiva da empresa e protegidos pela legislação brasileira.</p>
            <p className="font-medium text-foreground/90">É proibido:</p>
            <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">6. Coleta e proteção de dados (LGPD)</h2>
            <p className="text-muted-foreground">Tratamos os dados inseridos no Habitz com base no consentimento e no legítimo interesse, em conformidade com a Lei Geral de Proteção de Dados (Lei 13.709/18).</p>
            <p className="font-medium text-foreground/90">Usamos seus dados para:</p>
            <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
            ...
            <p className="text-muted-foreground">Reconhecemos que hábitos, rotina e bem-estar são dados sensíveis. Não compartilhamos essas informações com terceiros. Parte dos dados é armazenada localmente no dispositivo do usuário quando ele estiver offline.</p>
            <p className="font-medium text-foreground/90">Seus direitos:</p>
            <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">7. Responsabilidades e limitações</h2>
            <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">8. Atualizações e modificações</h2>
            <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">9. Disposições gerais</h2>
            <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
              <li>O Habitz é indicado para maiores de 18 anos. Menores devem ter autorização dos responsáveis.</li>
              <li>Suporte técnico: <a href={`mailto:${supportEmail}`} className="text-primary underline hover:text-primary/80">{supportEmail}</a> (resposta em até 48 horas úteis).</li>
