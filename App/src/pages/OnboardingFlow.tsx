      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Card className="p-6 md:p-8 mb-6">
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">Vamos começar conhecendo um pouco mais sobre você</p>
              </div>
                ...
                <div>
                  ...
                  <RadioGroup value={answers.ageRange} onValueChange={(value) => setAnswers({ ...answers, ageRange: value })}>
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="age1" className="font-normal cursor-pointer">13-17 anos</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="18-24" id="age2" />
                      <Label htmlFor="age2" className="font-normal cursor-pointer">18-24 anos</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="25-34" id="age3" />
                      <Label htmlFor="age3" className="font-normal cursor-pointer">25-34 anos</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="35-44" id="age4" />
                      <Label htmlFor="age4" className="font-normal cursor-pointer">35-44 anos</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="45+" id="age5" />
                      <Label htmlFor="age5" className="font-normal cursor-pointer">45+ anos</Label>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div>
                  ...
                  <RadioGroup value={answers.hasDiagnosis} onValueChange={(value) => setAnswers({ ...answers, hasDiagnosis: value })}>
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="diag1" className="font-normal cursor-pointer">Ainda não</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="suspeito" id="diag2" />
                      <Label htmlFor="diag2" className="font-normal cursor-pointer">Suspeito que sim</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="sim" id="diag3" />
                      <Label htmlFor="diag3" className="font-normal cursor-pointer">Sim, confirmadíssimo</Label>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div>
                  ...
                  <RadioGroup value={answers.usesMedication} onValueChange={(value) => setAnswers({ ...answers, usesMedication: value })}>
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="med1" className="font-normal cursor-pointer">Não</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="diariamente" id="med2" />
                      <Label htmlFor="med2" className="font-normal cursor-pointer">Sim, diariamente</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="especificos" id="med3" />
                      <Label htmlFor="med3" className="font-normal cursor-pointer">Sim, em dias específicos</Label>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div>
                  ...
                  <RadioGroup value={answers.energyPeriod} onValueChange={(value) => setAnswers({ ...answers, energyPeriod: value })}>
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="energy1" className="font-normal cursor-pointer">Manhã</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="tarde" id="energy2" />
                      <Label htmlFor="energy2" className="font-normal cursor-pointer">Tarde</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="noite" id="energy3" />
                      <Label htmlFor="energy3" className="font-normal cursor-pointer">Noite</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="variavel" id="energy4" />
                      <Label htmlFor="energy4" className="font-normal cursor-pointer">Variável</Label>
                    </div>
                  </RadioGroup>
                </div>
              </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Seus maiores desafios</h2>
                <p className="text-gray-600">Selecione todos que se aplicam ao seu dia a dia</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-6">
                  <Label htmlFor="specific" className="text-base font-semibold mb-2 block">
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Como você se sente hoje?</h2>
                <p className="text-gray-600">Avalie de 1 (Nada) a 5 (Muito)</p>
              </div>

              <div className="space-y-6">
                <div>
                  <div className="flex justify-between items-center mb-3">
                    <Label className="text-base font-semibold">Foco no dia a dia</Label>
                    <span className="text-2xl font-bold text-purple-600">{answers.focusLevel}</span>
                  </div>
                  <Slider
                ...
                <div>
                  <div className="flex justify-between items-center mb-3">
                    <Label className="text-base font-semibold">Motivação para começar</Label>
                    <span className="text-2xl font-bold text-purple-600">{answers.motivationLevel}</span>
                  </div>
                  <Slider
                ...
                <div>
                  <div className="flex justify-between items-center mb-3">
                    <Label className="text-base font-semibold">Nível de sobrecarga</Label>
                    <span className="text-2xl font-bold text-purple-600">{answers.overloadLevel}</span>
                  </div>
                  <Slider
                ...
                <div>
                  <div className="flex justify-between items-center mb-3">
                    <Label className="text-base font-semibold">Clareza de objetivos</Label>
                    <span className="text-2xl font-bold text-purple-600">{answers.clarityLevel}</span>
                  </div>
                  <Slider
                ...
                <div>
                  <div className="flex justify-between items-center mb-3">
                    <Label className="text-base font-semibold">Autoestima e autoconfiança</Label>
                    <span className="text-2xl font-bold text-purple-600">{answers.selfEsteemLevel}</span>
                  </div>
                  <Slider
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">Como você prefere receber orientações?</p>
              </div>
                ...
                <div>
                  ...
                  <RadioGroup value={answers.dailyTimeCommitment} onValueChange={(value) => setAnswers({ ...answers, dailyTimeCommitment: value })}>
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="time1" className="font-normal cursor-pointer">5-10 minutos</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="10-20" id="time2" />
                      <Label htmlFor="time2" className="font-normal cursor-pointer">10-20 minutos</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="20-30" id="time3" />
                      <Label htmlFor="time3" className="font-normal cursor-pointer">20-30 minutos</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="30+" id="time4" />
                      <Label htmlFor="time4" className="font-normal cursor-pointer">30+ minutos</Label>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div>
                  ...
                  <RadioGroup value={answers.environment} onValueChange={(value) => setAnswers({ ...answers, environment: value })}>
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="env1" className="font-normal cursor-pointer">Casa</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="trabalho" id="env2" />
                      <Label htmlFor="env2" className="font-normal cursor-pointer">Trabalho/Estudo</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="externo" id="env3" />
                      <Label htmlFor="env3" className="font-normal cursor-pointer">Espaço externo</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="outro" id="env4" />
                      <Label htmlFor="env4" className="font-normal cursor-pointer">Outro</Label>
                    </div>
                  </RadioGroup>
