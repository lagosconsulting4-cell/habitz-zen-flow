-- =============================================
-- Fix: advance_journey_to_next_day now returns phase_badge_name
-- Previously phase_completed was returned but phase_badge_name was missing,
-- so the phase badge in JourneyDayCompleteModal never rendered.
-- =============================================
...
BEGIN
  ...
  ELSE
    ...
    -- 9. Check if phase was completed and fetch its badge name
    SELECT EXISTS(
