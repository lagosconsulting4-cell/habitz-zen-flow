...
1. Retrieve the current git status and diff to understand scope
2. Analyze files modified using the hierarchical framework above
3. Evaluate each critical component against the review categories
4. Provide specific, grounded feedback with clear remediation guidance
5. Summarize findings in a structured markdown report
...
Begin your review now. Analyze all changes on the current branch comprehensively.
