          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-8 text-center">
                ...
                {/* Big Discount */}
                <div className="mb-6">
                  <div className="text-7xl md:text-8xl font-black text-[#A3E635] leading-none mb-2">
                    20%
                  </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="text-4xl font-bold text-slate-900 mb-1">
                    R$ 103,92<span className="text-xl text-slate-600">/ano</span>
                  </div>
                </div>
                ...
                <ul className="space-y-3 mb-6 text-left">
                  <li className="flex items-center gap-3 text-slate-700">
                    <Check className="w-5 h-5 text-[#A3E635] flex-shrink-0" />
                ...
                >
                  <Button
                    ...
                    className="w-full bg-[#A3E635] hover:bg-[#84cc16] text-slate-900 font-bold text-lg py-6 rounded-xl shadow-lg"
                  >
