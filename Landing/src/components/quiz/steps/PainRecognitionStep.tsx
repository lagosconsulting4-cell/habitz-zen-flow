...
export const PainRecognitionStep = () => {
    const { painFrequency, setPainFrequency, nextStep } = useQuiz();
        ...
        <div className="flex flex-col">
            ...
            >
                <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">
                    Você procrastina coisas <span className="text-lime-400">importantes?</span>
                </h2>
            </motion.div>
