...
export const HeroStep = () => {
  ...
  return (
    <div className="relative w-full h-[100dvh] bg-[#0A0A0B] overflow-hidden">
      {/* Background Image - Full Screen, anchored to top for consistent composition */}
      <img
      ...
      >
        ...
        {/* CTA - Bottom, respects iPhone home indicator */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
