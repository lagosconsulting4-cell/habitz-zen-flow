        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white font-sans overflow-x-hidden pt-8">
            ...
            <section className="container mx-auto px-4 lg:px-6 flex flex-col items-center text-center space-y-6 max-w-4xl pt-6 pb-12">
                <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight">
                    BEM-VINDO AOS BASTIDORES DO <span className="text-[#CCFF00]">BORA</span>.
                </h1>
                <p className="text-lg md:text-xl text-zinc-300 font-medium pb-4">
                    O que você vai descobrir aqui é como a nossa engrenagem realmente funciona.
                </p>
                ...
                <div className="w-full max-w-md mx-auto pt-6">
                    <Button
                        className="w-full h-16 text-lg font-bold bg-[#CCFF00] hover:bg-[#b3e600] text-black rounded-lg shadow-[0_0_20px_rgba(204,255,0,0.4)] transition-all"
            ...
            {/* Intro / Aquecimento Section (Subtle Secret Tone) */}
            <section className="container mx-auto px-4 lg:px-6 py-8 max-w-4xl hidden-until-pitch text-center">
                <h2 className="text-2xl md:text-3xl font-bold mb-4">Existe uma oportunidade passando despercebida bem na sua frente.</h2>
                <p className="text-lg text-zinc-400">
                    A maioria das pessoas acha que para gerar renda na internet é preciso aparecer, criar dancinhas ou tentar a sorte como influenciador. Mas o <strong className="text-white">Método Renda Secreta</strong> provou exatamente o oposto.
                    Criamos uma estrutura onde o seu foco está apenas na execução inteligente e no anonimato, faturando com um modelo oculto que o próprio algoritmo favorece, enquanto a sua rotina real continua intocada.
                </p>
            </section>

            {/* Curriculum Section */}
            <section className="container mx-auto px-4 lg:px-6 py-12 max-w-4xl hidden-until-pitch">
            ...
            {/* Bonuses Section */}
            <section className="container mx-auto px-4 lg:px-6 py-12 max-w-5xl hidden-until-pitch">
                <div className="text-center mb-10">
                    <h2 className="text-2xl md:text-3xl font-bold">Os Bônus e Materiais Inclusos <span className="text-[#CCFF00]">(Seu Arsenal):</span></h2>
                    <p className="text-zinc-400 mt-2">Além das aulas objetivas, a sua inscrição hoje destrava imediatamente todo o nosso pacote de atalhos absolutos.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="relative bg-zinc-900 border border-[#CCFF00]/30 rounded-xl p-6 flex flex-col items-center text-center overflow-hidden">
                        ...
                        <h3 className="font-bold text-lg mb-2">Comunidade de Networking</h3>
            ...
            <section id="offer" className="container mx-auto px-4 lg:px-6 py-16 max-w-3xl hidden-until-pitch">

                {/* Ancoragem (Stack) */}
                <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-6 md:p-8 mb-8">
                    <h3 className="text-xl md:text-2xl font-bold mb-6 text-center text-zinc-100">Se você fosse pagar separadamente por tudo:</h3>
                    <ul className="space-y-4 mb-6 text-zinc-300">
                        ...
                        <li className="flex justify-between items-center pt-2 font-bold text-xl">
                            <span>Valor Total Real:</span>
                            <span className="text-red-400 line-through">R$ 935,00</span>
                        </li>
                    </ul>
                    <p className="text-center text-[#CCFF00] font-bold text-lg mt-4">Mas hoje, como você decidiu evoluir, não pagará nem perto disso.</p>
                </div>
                ...
                <div className="relative rounded-2xl bg-gradient-to-b from-zinc-900 to-black border border-[#CCFF00]/30 p-1 shadow-[0_0_40px_rgba(204,255,0,0.15)] overflow-hidden">
                    ...
                    <div className="p-8 md:p-10 flex flex-col items-center text-center">
                        <h3 className="text-xl md:text-2xl font-bold mb-6 text-zinc-200">
                            Tenha acesso vitalício ao banco de imagens, à ferramenta e a todas as aulas do <span className="text-[#CCFF00]">Método Renda Secreta</span> por:
                        </h3>
                        ...
                        <div className="my-6">
                            ...
                            <div className="flex items-start justify-center text-[#CCFF00]">
                                ...
                                <span className="text-7xl font-black tracking-tighter">20,02</span>
                            </div>
                            <p className="text-zinc-500 mt-2 text-sm">(ou R$ 200 à vista)</p>
                        </div>

                        <Button
                            className="w-full max-w-sm h-16 text-xl font-bold bg-[#CCFF00] hover:bg-[#b3e600] text-black mt-6 rounded-xl shadow-[0_0_20px_rgba(204,255,0,0.4)] transition-all hover:scale-105"
                            onClick={() => window.location.href = 'https://pay.hub.la/Z11Q6cGxgTlT1yvqHgej'}
                        >
                            QUERO DESTRAVAR MEU ACESSO
                        </Button>

                        <div className="flex items-center justify-center gap-6 mt-8 flex-wrap opacity-60">
            ...
            {/* FAQ */}
            <section className="container mx-auto px-4 lg:px-6 py-16 max-w-3xl hidden-until-pitch">
                <div className="text-center mb-10">
...
export default MetodoRendaSecreta;
