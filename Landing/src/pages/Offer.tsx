                  ...
                  <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 relative z-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      {beforeProblems.map((item, index) => (
                        <motion.div
                          key={index}
                          className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-br from-card to-red-500/5 border border-red-500/20 shadow-lg"
                          initial={{ opacity: 0, y: 10 }}
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ delay: index * 0.1 }}
                        >
                          <div className="w-10 h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-red-500 to-rose-500 flex items-center justify-center flex-shrink-0 shadow-lg shadow-red-500/30">
                            <item.icon className="w-5 h-5 text-white" />
                          </div>
                          <span className="text-foreground font-medium text-sm sm:text-base pt-1 sm:pt-2">{item.text}</span>
                        </motion.div>
                      ))}
                    </div>
